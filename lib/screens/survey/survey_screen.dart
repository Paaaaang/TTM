...
class _SurveyScreenState extends State<SurveyScreen> {
  ...
  Widget _buildStep2() {
    ...
    final allergyOptions = [
      {'id': 'allergy-nuts', 'label': '견과류'},
      {'id': 'allergy-shellfish', 'label': '갑각류/해산물'},
      {'id': 'allergy-dairy', 'label': '우유/유제품'},
      {'id': 'allergy-eggs', 'label': '계란'},
    ];
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      spacing: 8,
                      runSpacing: 8,
                      children: allergyOptions.map((opt) {
                        return _buildAllergyChip(opt['id']!, opt['label']!);
                      }).toList(),
                    ),
                  ],
                ),
  ...
  Widget _buildAllergyChip(String id, String label) {
    bool isSelected = _allergies.contains(id);
    return InkWell(
      onTap: () {
        setState(() {
          if (isSelected) {
