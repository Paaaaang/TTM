...
class ExerciseLogCreate(BaseModel):
    ...
    exercise_type: str = 'AEROBIC'  # 기본값 설정
    exercise_name: str
...
async def create_exercise(exercise: ExerciseLogCreate):
    ...
    try:
        ...
        try:
            ...
            newly_earned = BadgeAutoAward.check_and_award_badges(exercise.member_id)
            if newly_earned:
                print(f"🎖️ 새로운 배지 {len(newly_earned)}개 획득: {[b['badge_name'] for b in newly_earned]}")
